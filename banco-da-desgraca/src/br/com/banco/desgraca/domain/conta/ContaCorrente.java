...
public class ContaCorrente extends Conta {
    ...
    public String toString() {
        return super.toString() + instituicaoBancaria + "\n";
    }
    ...
    public void sacar(Double valor) {
        ...
        if (valor % 5 != 0) {
            throw new ValorInvalidoException("O valor a ser sacado necessita ser multiplo de R$5,00");
        } else if (valor >= this.getSaldoDaConta()) {
            throw new ValorInvalidoException("O valor a ser sacado excede o saldo atual da conta.");
        } else {
            this.setSaldoDaConta(getSaldoDaConta() - valor);
            System.out.println("O valor a ser sacado é: R$" + DecimalFormat.getCurrencyInstance().format(valor));
    ...
    public void transferir(Double valor, ContaBancaria contaDestino) {
        ...
        } else if (getInstituicaoBancaria() != contaDestino.getInstituicaoBancaria()) {
